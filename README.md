...
----------------
In the longer term, the agent activity log which records every action every agent takes — becomes an audit trail. Governance bodies can see exactly when a deal was classified, who was notified, what the estimate was at submission, and when each artefact was signed off. That's currently very hard to reconstruct after the fact because the data lives in emails and meeting notes.
